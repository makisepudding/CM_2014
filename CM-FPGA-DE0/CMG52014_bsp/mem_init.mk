...
# Memory: Onchip_memory_SRAM
MEM_1 := nios_system_Onchip_memory_SRAM
$(MEM_1)_NAME := Onchip_memory_SRAM
...
$(MEM_1)_HIERARCHICAL_PATH := Onchip_memory_SRAM
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: Onchip_memory_SRAM
Onchip_memory_SRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
